    ...
    >
      <div className={cn("flex items-center", expanded ? "justify-between px-1" : "justify-center")}>
        <button
          ...
          className={cn("flex min-w-0 items-center", expanded ? "gap-2.5" : "justify-center")}
        >
      ...
      <div className={cn("mt-4 border-t border-sidebar-border pt-3", expanded ? "px-1" : "px-0")}>
        <div
          className={cn("flex items-center rounded-xl bg-muted/50", expanded ? "gap-3 px-3 py-2.5" : "size-11 justify-center")}
